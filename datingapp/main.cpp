...
const std::string MEMBERS_FILE    = "/Users/alexye/Desktop/datingapp/datingapp/members.txt";
const std::string TRANSLATOR_FILE = "/Users/alexye/Desktop/datingapp/datingapp/translator.txt";
